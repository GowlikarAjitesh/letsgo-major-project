...
const RestaurantsList = () => {
    ...
    useEffect(() => {
        ...
        //         setRestaurants(data?.filter(restaurant => restaurant.hasOwnProperty('name')));
        ...
        //     })
            ...
            .then(data => {
                ...
                setRestaurants(data.filter(item => item.min_rating != 0 && item.location_id != 0 && item.name))
                            ...
                            restaurants?.map((restaurant, i) => (
                                <div key={i} className="grid grid-cols-12 my-2 border border-gray-200 rounded shadow hover:shadow-xl cursor-pointer">
                                    ...
                                    <div className="col-span-12 md:col-span-4 h-[180px]">
                                        ...
                                        <Link to={`${restaurant?.location_id}`}>
